...
const MEM_PAGE_SIZE = 32; // Show 32 bytes per page in memory editor

// Helper to format hex with leading zeros
...
export default function SimulatorInput() {
    ...
    const parseAssembly = (text: string) => {
        try {
            ...
            // Parse starting from 'program' rule (adjust if your grammar differs)
